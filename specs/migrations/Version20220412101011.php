 ...
 */
final class Version20220412101011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE progress_state (id INT AUTO_INCREMENT NOT NULL, course_id INT DEFAULT NULL, section_id INT DEFAULT NULL, lesson_id INT DEFAULT NULL, state TINYINT(1) NOT NULL, INDEX IDX_412B21C0591CC992 (course_id), INDEX IDX_412B21C0D823E37A (section_id), INDEX IDX_412B21C0CDF80196 (lesson_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
